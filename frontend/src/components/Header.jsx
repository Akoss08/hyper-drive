      ...
      >
        <nav className="flex items-center gap-4 max-w-screen-xl mx-auto w-full">
          <Link to="/" className="max-sm:hidden">
            <img src="/logos/Black_Modern_Car_Auto_Services_Logo-removebg-preview.avif" alt="logo" width="134" />
          </Link>
          <Link to="/" className="hidden max-sm:block">
            <img src="/logos/Black_Modern_Car_Auto_Services_Logo__1_-removebg-preview.avif" alt="logo" width="200" />
          </Link>
          ...
          >
            ...
            >
              <li className="mb-6 hidden max-lg:block">
                <Link to="/">
                  <img src="/logos/Screenshot_2025-03-27_172543-removebg-preview.avif" alt="logo" width="150" />
                </Link>
              </li>
