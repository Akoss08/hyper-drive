  ...
  return (
    <footer className="from-neutral-500 to-35% to-neutral-600 bg-gradient-to-b pt-12 pb-6 px-10 tracking-wide">
      <div className="max-w-screen-xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:flex lg:items-center">
            <Link to="/" className="max-sm:hidden">
              <img src="../src/assets/logos/Black_Modern_Car_Auto_Services_Logo-removebg-preview.png" alt="logo" className="w-48" />
            </Link>
            <Link to="/" className="hidden max-sm:block">
              <img src="../src/assets/logos/Black_Modern_Car_Auto_Services_Logo__1_-removebg-preview.png" alt="logo" className="w-48" />
            </Link>
          </div>
            ...
            <ul className="flex space-x-6">
              <li>
                <a href="https://www.facebook.com" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-500 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
                    <path
                      fillRule="evenodd"
              ...
              <li>
                <a href="https://www.twitter.com" target="_blank">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="fill-gray-500 hover:fill-white w-7 h-7" viewBox="0 0 24 24">
        ...
        <p className="text-gray-400 text-sm mt-10">© Hyperdrive. All rights reserved.</p>
      </div>
    </footer>
  );
}
